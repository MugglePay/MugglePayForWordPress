...
final class MPWP_WC_Usdt_Methods extends AbstractPaymentMethodType {
	/**
	 * Payment method name/id/slug.
	 *
	 * @var string
	 */
	protected $name = 'usdt_methods';
	...
	public function get_payment_method_script_handles() {
		$script_url = plugins_url( "/assets/js/blocks/usdt_methods.js", MPWP_MAIN_FILE );
		...
		wp_set_script_translations( 'usdt_methods', 'mugglepay' );

		return array( "usdt_methods" );
	}
	...
	public function get_payment_method_data() {
		...
		return array(
			'title'             => $this->gateway->gateway_methods['usdt_methods']['title'],
			'description'       => '',
			'supports'          => array_filter( $this->gateway->supports, array( $this->gateway, 'supports' ) ),
            'icon'              => MPWP_PLUGIN_URL . '/assets/images/usdt.png',
	...
	public function mpwp_failed_payment_notice( PaymentContext $context, PaymentResult &$result ) {
		if ( 'usdt_methods' === $context->payment_method ) {
			// add_action(
