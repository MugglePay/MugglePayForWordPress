...
final class MPWP_WC_Muggle_Pay_Methods extends AbstractPaymentMethodType {
	/**
	 * Payment method name/id/slug.
	 *
	 * @var string
	 */
	protected $name = 'muggle_pay_methods';
	...
	public function get_payment_method_script_handles() {
		$script_url = plugins_url( "/assets/js/blocks/muggle_pay_methods.js", MPWP_MAIN_FILE );
		...
		wp_set_script_translations( 'muggle_pay_methods', 'muggle_pay_methods' );

		return array( "muggle_pay_methods" );
	}
	...
	public function get_payment_method_data() {
		...
		return array(
			'title'             => $this->gateway->gateway_methods['muggle_pay_methods']['title'],
			'description'       => '',
			'supports'          => array_filter( $this->gateway->supports, array( $this->gateway, 'supports' ) ),
            'icon'              => MPWP_PLUGIN_URL . '/assets/images/mugglepay-logo-c.png',
	...
	public function mpwp_failed_payment_notice( PaymentContext $context, PaymentResult &$result ) {
		if ( 'muggle_pay_methods' === $context->payment_method ) {
			// add_action(
