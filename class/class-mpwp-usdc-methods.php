...
final class MPWP_WC_Usdc_Methods extends AbstractPaymentMethodType {
	/**
	 * Payment method name/id/slug.
	 *
	 * @var string
	 */
	protected $name = 'usdc_methods';
	...
	public function get_payment_method_script_handles() {
		$script_url = plugins_url( "/assets/js/blocks/usdc_methods.js", MPWP_MAIN_FILE );
		...
		wp_set_script_translations( 'usdc_methods', 'usdc_methods' );

		return array( "usdc_methods" );
	}
	...
	public function get_payment_method_data() {
		...
		return array(
			'title'             => $this->gateway->gateway_methods['usdc_methods']['title'],
			'description'       => '',
			'supports'          => array_filter( $this->gateway->supports, array( $this->gateway, 'supports' ) ),
            'icon'              => MPWP_PLUGIN_URL . '/assets/images/usdc.png',
	...
	public function mpwp_failed_payment_notice( PaymentContext $context, PaymentResult &$result ) {
		if ( 'usdc_methods' === $context->payment_method ) {
			// add_action(
